...
ControladorAsignarAsignaturasDocente.o: controladores/ControladorAsignarAsignaturasDocente.cpp controladores/ControladorAsignarAsignaturasDocente.h
	g++ -c controladores/ControladorAsignarAsignaturasDocente.cpp -o ControladorAsignarAsignaturasDocente.o
