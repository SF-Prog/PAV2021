...
main: 	ControladorAltaAsignatura.o ControladorAltaUsuario.o ManejadorAsignatura.o ManejadorPerfil.o Asignatura.o Docente.o Estudiante.o  Perfil.o DtAsignatura.o  DtPerfil.o DtInstanciaClase.o main.o Fabrica.o
	g++	main.o Fabrica.o  ControladorAltaAsignatura.o	ControladorAltaUsuario.o ManejadorAsignatura.o ManejadorPerfil.o Asignatura.o 	Docente.o Estudiante.o Perfil.o DtAsignatura.o  DtPerfil.o DtInstanciaClase.o -o	obligatorio.exe
